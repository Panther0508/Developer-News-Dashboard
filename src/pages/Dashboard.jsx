    ...
    <div className="min-h-screen bg-black">
      ...
      >
        <div className="max-w-7xl mx-auto">
          <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-[#1a1a1a] via-[#111111] to-black p-8 md:p-12 border border-[#333333]">
              ...
              <button
                ...
                className={`px-4 py-2 rounded-lg text-sm font-medium transition-all whitespace-nowrap ${
                  activeCategory === cat.id
                    ? 'bg-gold text-black'
                    : 'bg-[#1a1a1a] text-gray-400 hover:text-gold hover:bg-[#262626] border border-[#333333]'
                }`}
              >
                {cat.label}
              </button>
